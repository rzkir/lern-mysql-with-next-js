                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    value={signinEmailOrName}
                                    onChange={(e) => setSigninEmailOrName(e.target.value)}
                                    required
                                    placeholder="Enter your email"
                                    className={`w-full pl-11 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-600 ${signinFieldErrors.emailOrName
                                        ? 'border-red-500'
                                        : 'border-gray-300'
                                        }`}
                                />
                            </div>
                            {signinFieldErrors.emailOrName && (
                                <p className="mt-1 text-xs text-red-600">{signinFieldErrors.emailOrName}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-11 pr-12 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-600 ${signinFieldErrors.password
                                        ? 'border-red-500'
                                        : 'border-gray-300'
                                        }`}
                                />
                            ...
                            {signinFieldErrors.password && (
                                <p className="mt-1 text-xs text-red-600">{signinFieldErrors.password}</p>
                            )}
                        </div>
